...
and produces an interactive dashboard plus a candid written analysis.

**You don't need to understand any of the technical steps.** Here's all you do:

1. Install **Claude Code** (or the Claude desktop app's coding mode) if you don't
